    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_coord', models.CharField(blank=True, max_length=128, null=True, verbose_name='Координаты')),
                ('meeting_point', models.CharField(blank=True, max_length=128, null=True, verbose_name='Точка сбора')),
